...
////////////////////////////////////////////////////////////////////////							
		...
		'shortcodes' => array(
/////////add shortcodes by Navdeep Bagga(admin@navdeepbagga.com)////////		
			//First Name
			'first_name' => array(
				'shortcode' => '[first_name]',
				'popup_title' => __('Insert First Name', 'academy')
			),
			
			//Last Name
			'last_name' => array(
				'shortcode' => '[last_name]',
				'popup_title' => __('Insert Last Name', 'academy')
			),
			
			//User ID
			'user_id' => array(
				'shortcode' => '[user_id]',
				'popup_title' => __('Insert User ID', 'academy')
			),
			
			//Display Name
			'display_name' => array(
				'shortcode' => '[display_name]',
				'popup_title' => __('Insert Display Name', 'academy')
			),
			
			//User Login
			'user_login' => array(
				'shortcode' => '[user_login]',
				'popup_title' => __('Insert User Login', 'academy')
			),
			
			//User Email
			'user_email' => array(
				'shortcode' => '[user_email]',
				'popup_title' => __('Insert User Email', 'academy')
			),
			
			//License Number
			'license_number' => array(
				'shortcode' => '[license_number]',
				'popup_title' => __('Insert License Number', 'academy')
			),
			
			//State
			'state' => array(
				'shortcode' => '[state]',
				'popup_title' => __('Insert State', 'academy')
			),
////////////////////////////////////////////////////////////////////////
			//Columns
			'column' => array(
		...
		'custom_styles' => array (
			...
			array(
				'elements' => 'input[type="submit"], input[type="button"], .button, .jp-play-bar, .jp-volume-bar-value, .free-course .course-price .price-text, .lessons-listing .lesson-attachments a, ul.styled-list.style-4 li:before',
			...
			array(
				'elements' => '.button.secondary, .quiz-listing .question-number, .lessons-listing .lesson-title .course-status, .course-price .price-text, .course-price .corner, .course-progress span, .questions-listing .question-replies, .course-price .corner-background, .user-links a:hover, .payment-listing .expanded .toggle-title:before, .styled-list.style-5 li:before, .faq-toggle .toggle-title:before, ul.styled-list.style-1 li:before, p.stars span a:hover, p.stars span a.active, p.stars span a:focus',
	...
	'options' => array (
		...
		array(	'name' => __('Date Format','academy'),
				'id' => 'date_format',
				'options' => array (	
					'm/d/Y'=>'MM/DD/YY',
					'd/m/Y'=>'DD/MM/YY',					
