...
//First Name
add_shortcode('first_name','themex_first_name');
function themex_first_name() {
	 global $current_user;
	$out=get_currentuserinfo();
	return $current_user->user_firstname;
}

//Last Name
add_shortcode('last_name','themex_last_name');
function themex_last_name() {
	 global $current_user;
	$out=get_currentuserinfo();
...
//User ID
add_shortcode('user_id','themex_user_id');
function themex_user_id() {
	 global $current_user;
	$out=get_currentuserinfo();
...
//Display Name
add_shortcode('display_name','themex_display_name');
function themex_display_name() {
	 global $current_user;
	$out=get_currentuserinfo();
...
//User Login
add_shortcode('user_login','themex_user_login');
function themex_user_login() {
	 global $current_user;
	$out=get_currentuserinfo();
...
//User Email
add_shortcode('user_email','themex_user_email');
function themex_user_email() {
	 global $current_user;
	$out=get_currentuserinfo();
...
//License Number
add_shortcode('license_number','themex_license_number');
function themex_license_number() {
	 global $current_user;
	$out=get_currentuserinfo();
	return get_user_meta($current_user->ID, 'license_number', true ); 
}

//State
add_shortcode('state','themex_state');
function themex_state() {
	 global $current_user;
	$out=get_currentuserinfo();
	return get_user_meta($current_user->ID, 'user_state', true ); 
}
////////////////////////////////////////////////////////////////////////
