...
/////////EDIT by Navdeep Bagga(admin@navdeepbagga.com)//////////////////					
					a.addWithPopup( b, "First Name", "first_name" );
					a.addWithPopup( b, "Last Name", "last_name" );
					a.addWithPopup( b, "User ID", "user_id" );
					a.addWithPopup( b, "Display Name", "display_name" );
					a.addWithPopup( b, "User Login", "user_login" );
					a.addWithPopup( b, "User Email", "user_email" );
					a.addWithPopup( b, "License Number", "license_number" );
					a.addWithPopup( b, "State", "state" );
////////////////////////////////////////////////////////////////////////					
