...
<!--/////EDIT by Navdeep Bagga(admin@navdeepbagga.com)///////////////-->			
			<div class="sixcol column">
				<div class="field-wrapper">
					<input type="text" name="user_fname" placeholder="<?php _e('Firstname','academy'); ?>" />
				</div>								
			</div>
			<div class="sixcol column last">
				<div class="field-wrapper">
					<input type="text" name="user_lname" placeholder="<?php _e('Lastname','academy'); ?>" />
				</div>
			</div> 
			<div class="sixcol column">
				<div class="field-wrapper">
			...
			<div class="sixcol column">
				<div class="field-wrapper">
					<input type="text" name="user_license" placeholder="<?php _e('License Number','academy'); ?>" />
				</div>								
			</div>
			<div class="sixcol column last">
				<div class="field-wrapper">
					<select size="1" width="150px;" name="user_state">
					<option>State</option>
